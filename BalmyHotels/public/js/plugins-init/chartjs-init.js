 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(221, 47, 110, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(221, 47, 110, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(221, 47, 110, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(221, 47, 110, 0.5)");
		...
		//basic line chart
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(221, 47, 110, 1)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(221, 47, 110, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(221, 47, 110, 0.5)");
					...
					datasets: [
						{
							...
							backgroundColor: 'transparent', 
							tension:0.5,
							pointBackgroundColor: 'rgba(221, 47, 110, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(221, 47, 110, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(221, 47, 110, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 184, 0, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 184, 0, 1)");
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(221, 47, 110, 0.5)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
						_stroke.apply(this, arguments);
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(243, 87, 87, 0.2)");
			areaChart_2gradientStroke.addColorStop(1, "rgba(243, 87, 87, 0)");
