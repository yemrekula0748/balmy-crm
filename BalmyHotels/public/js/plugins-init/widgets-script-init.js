 ...
 var dzChartlist = function(){
	...
	var chartWidget2 = function(){
		...
		if(jQuery('#chart_widget_2').length > 0 ){
			...
			chart_widget_2gradientStroke.addColorStop(0, "#dd2f6e");
			chart_widget_2gradientStroke.addColorStop(1, "#f24a87");
	...
	var chartWidget7 = function(){
		...
		chart_widget_7gradientStroke.addColorStop(0, "#2bc155");
		chart_widget_7gradientStroke.addColorStop(1, "#2bc155");
		...
		new Chart(chart_widget_9, {
			...
			data: {
				...
				datasets: [{
					...
					pointBorderColor: '#2F4CDD',
					pointHoverBackgroundColor: '#2F4CDD',
					pointHoverBorderColor: '#2F4CDD',
					fill:true,
		...
		new Chart(chart_widget_10, {
			...
			data: {
				...
				datasets: [{
					...
					backgroundColor: "#e4386a",
					borderColor: '#e4386a',
					pointBackgroundColor: '#e4386a',
					pointBorderColor: '#e4386a',
					pointHoverBackgroundColor: '#e4386a',
					pointHoverBorderColor: '#e4386a',
					borderWidth: 0, 
					fill:true,
		...
		new Chart(chart_widget_11, {
			...
			data: {
				...
				datasets: [{
					...
					borderColor: '#2bc155',
					pointBackgroundColor: '#2bc155',
					pointBorderColor: '#2bc155',
					pointHoverBackgroundColor: '#2bc155',
					pointHoverBorderColor: '#2bc155',
					fill:true,
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(26, 51, 213, 1)', 
							tension:0.5,
							fill:true,
							pointRadius: 0
						}
