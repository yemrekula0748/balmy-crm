							...
							<table class="table table-sm mb-0">
								...
								<tbody id="orders">
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong class="text-primary">#181</strong></a> by <strong class="text-primary">Ricky
										...
										<td class="py-2 text-end"><span class="badge badge-success badge-sm light">Completed<span
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong class="text-primary">#182</strong></a> by <strong class="text-primary">Kin Rossow</strong><br><a href="mailto:kin@example.com">kin@example.com</a></td>
										<td class="py-2">20/04/2020</td>
										<td class="py-2">Kin Rossow, 1 Hollywood Blvd,Beverly Hills, California 90210
											<p class="mb-0 text-500">Via Free Shipping
											</p>
										</td>
										<td class="py-2 text-end"><span class="badge badge-primary badge-sm light">Processing<span
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong class="text-primary">#183</strong></a> by <strong class="text-primary">Merry
										...
										<td class="py-2 text-end"><span class="badge badge-secondary badge-sm light">On
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#184</strong></a> by <strong  class="text-primary">Bucky
										...
										<td class="py-2 text-end"><span class="badge badge-warning badge-sm light">Pending<span
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#185</strong></a> by <strong  class="text-primary">Rocky
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#186</strong></a> by <strong  class="text-primary">Ricky John</strong><br><a href="mailto:ricky@example.com">ricky@example.com</a></td>
										<td class="py-2">30/04/2020</td>
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#187</strong></a> by <strong  class="text-primary">Cristofer
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#188</strong></a> by <strong  class="text-primary">Brate Lee</strong><br ><a href="mailto:lee@example.com">lee@example.com</a></td>
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#189</strong></a> by <strong  class="text-primary">Thomas
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#190</strong></a> by <strong  class="text-primary">Evie Singh</strong><br><a href="mailto:eviewsing@example.com">eviewsing@example.com</a>
										</td>
										<td class="py-2">29/04/2020</td>
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#191</strong></a> by <strong  class="text-primary">David
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-2">
											<a href="#">
												<strong  class="text-primary">#192</strong></a> by <strong  class="text-primary">Jennifer
