        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="slider-update ">
                            ...
                            <button class="update-button btn btn-primary btn-sm mb-2" id="update-1">Set range [20, 50]</button>
                            <button class="update-button btn btn-primary btn-sm mb-2" id="update-2">Set range [10, 40]</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-title mb-3 mb-xl-4"></div>
                    ...
                    <div class="card-body">
                        <div class="getnset-slider">
                            ...
                            <div class="logger mt-4">
                                ...
                                <button class="btn btn-primary btn-sm" id="read-button">Read slider value</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="locked-slider">
                            ...
                            <button class="btn btn-primary btn-sm mt-4" id="lockbutton" style="float: right; margin: 20px 0 0;">Lock</button>
                        </div>
                    </div>
                </div>
            </div>
