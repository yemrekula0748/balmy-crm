		...
		<div class="row">
				...
				<div class="card overflow-hidden">
					<div class="card-header media border-0 pb-0">
						<div class="media-body">
							<h2 class="text-black">56 <span class="text-success fs-14">+4%</span></h2>
							<p class="mb-0 text-black">Menus</p>
						</div>
			...
			<div class="col-xl-3 col-lg-3 col-sm-6">
				<div class="card overflow-hidden">
					<div class="card-header media border-0 pb-0">
						<div class="media-body">
							<h2 class="text-black">785 <span class="text-success fs-14">+2.7%</span></h2>
							<p class="mb-0 text-black">Orders</p>
						</div>
			...
			<div class="col-xl-3 col-lg-3 col-sm-6">
				<div class="card overflow-hidden">
					<div class="card-header media border-0 pb-0">
						<div class="media-body">
							<h2 class="text-black">56 <span class="text-danger fs-14">-3%</span></h2>
			...
			<div class="col-xl-3 col-lg-3 col-sm-6">
				<div class="card overflow-hidden">
					<div class="card-header media border-0 pb-0">
						<div class="media-body">
							<h2 class="text-black">$6231 <span class="text-danger fs-14">-3.7%</span></h2>
				...
				<div class="card">
					<div class="card-header pb-0 border-0 flex-wrap">
						<div class="mb-2">
							...
							<p class="fs-13 mb-0">Lorem ipsum dolor sit amet,consecteture</p>
						</div>
					...
					<div class="card-body px-0 px-sm-3">
						<div class="d-flex justify-content-center">
							<div class="text-center px-2 px-md-5">
								...
								<h4 class="text-black font-w600 mb-0 fs-22">$561,623</h4>
							</div>
							<div class="text-center px-2 px-md-5">
								<p class="fs-14 mb-1">Expense</p>
								<h4 class="text-black font-w600 mb-0 fs-22">$126,621</h4>
							</div>
						</div>
						<div id="chartBar"></div>
					</div>
						...
						<div class="table-responsive ">
							<table class="table order-request">
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('images/card/pic1.jpg')}}" alt="DexignZone">
											<div class="media-body">
												<h5 class="mt-0 mb-2"><a class="text-black" href="{{ url('ecom-product-detail')}}">Tuna Soup spinach with himalaya salt.</a></h5>
									...
									<td>
										<div class="d-flex align-items-center">
											<a class="btn btn-warning light btn-sm" href="javascript:;">PENDING</a>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('images/card/pic2.jpg')}}" alt="DexignZone">
											<div class="media-body">
												<h5 class="mt-0 mb-2"><a href="{{ url('ecom-product-detail')}}" class="text-black">Mozarella Pizza With Random Topping</a></h5>
												<p class="mb-0 text-primary">#0010299</p>
											</div>
										</div>
									</td>
									<td>
										<h5 class="mb-2 text-black wspace-no">Kinda Alexa</h5>
									...
									<td>
										<div class="d-flex align-items-center">
											<a class="btn btn-success light btn-sm" href="javascript:;">DELIVERED</a>
											<div class="dropdown ms-auto  c-pointer">
												<div class="btn-link" data-bs-toggle="dropdown">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="12" cy="5" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="19" r="2"></circle></g></svg>
												</div>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('images/card/pic3.jpg')}}" alt="DexignZone">
											<div class="media-body">
												<h5 class="mt-0 mb-2"><a href="{{ url('ecom-product-detail')}}" class="text-black">Sweet Cheezy Pizza for Kids Meal (Small Size)</a></h5>
												<p class="mb-0 text-primary">#0010235</p>
											</div>
										</div>
									</td>
									<td>
										...
										<p class="mb-0">Franklin Avenue St.66125 London</p>
									</td>
									<td>
										<div class="d-flex align-items-center justify-content-center">
											<h4 class="mb-0 me-3 fs-20 text-black d-inline-block">$4.2</h4>
											<p class="mb-0 fs-20 d-inline-block">x2</p>
										</div>
									</td>
									<td>
										<div class="d-flex align-items-center">
											<a class="btn btn-danger light btn-sm" href="javascript:;">CANCELED</a>
											<div class="dropdown ms-auto  c-pointer">
												<div class="btn-link" data-bs-toggle="dropdown">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="12" cy="5" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="19" r="2"></circle></g></svg>
												</div>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('images/card/pic6.jpg')}}" alt="DexignZone">
											<div class="media-body">
												<h5 class="mt-0 mb-2"><a href="{{ url('ecom-product-detail')}}" class="text-black">Tuna soup spinach with himalaya salt</a></h5>
												<p class="mb-0 text-primary">#0010235</p>
											</div>
										</div>
									</td>
								...
								<tr>
									<td>
										<div class="media align-items-center">
											<img class="me-3 img-fluid rounded-circle" width="75" src="{{ asset('images/card/pic7.jpg')}}" alt="DexignZone">
											<div class="media-body">
												<h5 class="mt-0 mb-2"><a href="{{ url('ecom-product-detail')}}" class="text-black">Mozarella Pizza With Random Topping</a></h5>
												<p class="mb-0 text-primary">#0010299</p>
											</div>
							...
							<ul class="timeline">
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-3"><a href="{{ url('ecom-product-detail')}}" class="text-black">Chicken curry special with cucumber</a></h5>
								...
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-3"><a href="{{ url('ecom-product-detail')}}" class="text-black">Watermelon juice with ice</a></h5>
											<div class="d-flex justify-content-between align-items-center">
								...
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-3"><a href="{{ url('ecom-product-detail')}}" class="text-black">Italiano pizza with garlic</a></h5>
											<div class="d-flex justify-content-between align-items-center">
								...
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-3"><a href="{{ url('ecom-product-detail')}}" class="text-black">Tuna soup spinach with himalaya salt</a></h5>
											<div class="d-flex justify-content-between align-items-center">
								...
								<li>
									<div class="timeline-panel">
										...
										<div class="media-body">
											<h5 class="mb-3"><a href="{{ url('ecom-product-detail')}}" class="text-black">Medium Spicy Spagethi Italiano</a></h5>
											<div class="d-flex justify-content-between align-items-center">
