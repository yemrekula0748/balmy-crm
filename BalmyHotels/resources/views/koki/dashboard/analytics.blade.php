		...
		<div class="row">
			<div class="col-xl-9 col-xxl-12">
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header border-0 pb-0 flex-wrap d-lg-flex d-block">
								<div class="mb-3 me-3">
								...
								<div class="card-action card-tabs mb-3">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-bs-toggle="tab" href="#all-categories" role="tab">
												All Categories
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#main-course" role="tab">
												Main Course
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#pizza" role="tab">
												Pizza
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#drink" role="tab">
												Drink
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#dessert" role="tab">
												Dessert
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#more" role="tab">
												More
											</a>
										</li>													
									</ul>
							...
							<div class="card-body tab-content p-0">
								<div class="tab-pane fade active show" id="all-categories">
									<div class="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
										<div class="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
											<div class="media align-items-center">
												...
												<div class="media-body">
													...
													<a href="javascript:void(0);" class="text-primary fs-14 d-flex align-items-center"><i class="fas fa-heart fs-20 me-2" aria-hidden="true"></i> <strong>256k</strong> Like it</a>
												</div>
											</div>
										</div>
										...
										<div class="col-xl-2 col-lg-2 col-sm-6 col-6">
											<div class="d-flex align-items-flex-end mb-1">
												<svg class="me-3" width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="col-xl-2 col-lg-2 col-sm-6 col-6 text-end">
									...
									<div class="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
										<div class="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
											<div class="media align-items-center">
												<img class="rounded me-3" src="{{ asset('images/card/pic7.jpg')}}" alt="" width="105">
												<div class="media-body">
					...
					<div class="col-lg-4 col-md-6">
						<div class="card">
							...
							<div class="card-body height360 dz-scroll loadmore-content" id="loyalCustomersContent">	
								<div class="media align-items-center mb-4">		
									<img class="me-3 rounded" src="{{ asset('images/profile/5.jpg')}}" width="70" alt="">
									<div class="media-body">
								...
								<div class="media align-items-center mb-4">		
									<img class="me-3 rounded" src="{{ asset('images/profile/6.jpg')}}" width="70" alt="">
									<div class="media-body">
								...
								<div class="media align-items-center mb-4">		
									<img class="me-3 rounded" src="{{ asset('images/profile/7.jpg')}}" width="70" alt="">
									<div class="media-body">
								...
								<div class="media align-items-center mb-4">		
									<img class="me-3 rounded" src="{{ asset('images/profile/10.jpg')}}" width="70" alt="">
									<div class="media-body">
							...
							<div class="card-footer border-0 text-center">
								<a href="javascript:void(0);" class="btn-link dz-load-more" rel="{{ url('loyal-customers')}}" id="loyalCustomers">View More &gt;&gt;</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-xxl-6 col-md-6">	
						<div class="card best-items-box">
							...
							<div class="height800 dz-scroll loadmore-content" id="bestMenusContent">
							...
							<div class="card-footer text-center">
								<a href="javascript:void(0);" class="btn-link dz-load-more" rel="{{ url('best-menus')}}" id="bestMenus">View More &gt;&gt;</a>
							</div>
						</div>
					</div>
				</div>
