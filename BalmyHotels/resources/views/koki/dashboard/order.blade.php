...
@section('content')
	...
	<div class="form-head d-flex mb-3 mb-md-5 align-items-start flex-wrap">
		<div class="me-auto">
			<a class="text-primary d-flex align-items-center mb-3 font-w500" href="#">
			...
			Back</a>
			<h3 class="text-black font-w600 mb-0 fs-22 mb-2">Order ID #5552351</h3>
			<a class="mb-0 text-black font-w500" href="#">Orders  /</a>
			<a class="mb-0 font-w500" href="#"> Order Detaills </a>
		</div>
		<div class="dropdown ms-auto">
			<div class="btn btn-primary btn-rounded dropdown-toggle d-block  px-4" data-bs-toggle="dropdown">
					...
					<div class="card">
						<div class="card-body">
							<div class="full-map-area">
								<img src="{{ asset('images/svg/map.svg') }}" alt="" style="width:100%;"> 
						...
						<div class="card-body rounded" style="background:#3f4953;">
							<div class="row mx-0 align-items-center">
								<div class="media align-items-center col-md-12 col-xl-6 col-lg-4 px-0 mb-3 mb-md-0">
									<img class="me-3 img-fluid rounded-circle" width="100" src="{{ asset('images/profile/5.png')}}" alt="DexignZone">
									<div class="media-body">
										<p class="text-white mb-1 wspace-no">Delivery guy</p>
										<h3 class="mb-1 text-white  fs-22">Rainold Hawkins</h3>
										<small class="text-gray wspace-no">ID 412455</small>
									</div>
								</div>
							...
							<div class="table-responsive order-list">
								<table class="table items-table">
									<tbody><tr>
										...
										<th class="text-black font-w500 fs-20">Deleted</th>
									</tr>
									<tr>
										<td>
											<div class="media">
												<a href="{{ url('ecom-product-detail')}}"><img class="me-3 img-fluid rounded" width="85" src="{{ asset('images/card/pic5.jpg')}}" alt="DexignZone"></a>
												<div class="media-body">
													<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
													<h5 class="mt-0 mb-2 mb-4"><a class="text-black" href="{{ url('ecom-product-detail')}}">Watermelon juice with ice</a></h5>
									...
									<tr>
										<td>
											<div class="media">
												<a href="{{ url('ecom-product-detail')}}"><img class="me-3 img-fluid rounded" width="85" src="{{ asset('images/card/pic6.jpg')}}" alt="DexignZone"></a>
												<div class="media-body">
													<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
													<h5 class="mt-0 mb-2 text-black mb-4"><a class="text-black" href="{{ url('ecom-product-detail')}}">Chicken curry special with cucumber</a></h5>
													<div class="star-review fs-14">
														<i class="fas fa-star text-orange"></i>
														<i class="fas fa-star text-orange"></i>
														<i class="fas fa-star text-orange"></i>
									...
									<tr>
										<td>
											<div class="media">
												<a href="{{ url('ecom-product-detail')}}"><img class="me-3 img-fluid rounded" width="85" src="{{ asset('images/card/pic7.jpg')}}" alt="DexignZone"></a>
												<div class="media-body">
													<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
					...
					<div class="card">
						<div class="card-body border-bottom">
							<div class="media align-items-center">
								<img class="me-3 rounded-circle" src="{{ asset('images/profile/6.jpg')}}" width="90" alt="">
								<div class="media-body">
									<h4 class="text-black mb-3">James Witwitcky</h4>
									<span class="btn btn-primary light brn-sm fs-14 p-2 rounded">Customer</span>
								</div>
							</div>
						</div>
						<div class="card-body border-bottom">
						...
						<div class="card-body border-bottom">
							<div class="media align-items-center">
								<svg class="me-4" width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="min-width: 24px;">
									<path d="M28 13.3333C28 22.6667 16 30.6667 16 30.6667C16 30.6667 4 22.6667 4 13.3333C4 10.1507 5.26428 7.09848 7.51472 4.84805C9.76516 2.59761 12.8174 1.33333 16 1.33333C19.1826 1.33333 22.2348 2.59761 24.4853 4.84805C26.7357 7.09848 28 10.1507 28 13.3333Z" stroke="var(--primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
									<path d="M16 17.3333C18.2091 17.3333 20 15.5425 20 13.3333C20 11.1242 18.2091 9.33333 16 9.33333C13.7909 9.33333 12 11.1242 12 13.3333C12 15.5425 13.7909 17.3333 16 17.3333Z" stroke="var(--primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
								</svg>
								<h4 class="mb-0 text-black">Long Horn St. Avenue 351636 London</h4>
							</div>
						</div>
						<div class="card-body">
				...
				<div class="col-xl-12 col-md-6 col-xxl-6">
					<div class="card">
						<div class="card-header border-0">
							<h4 class="text-black font-w600 wspace-no">Customer Favorites</h4>
						</div>
						<div class="card-body pt-0">
							...
							<div class="mb-3">
								<div class="d-flex justify-content-between mb-3">
									<p class="mb-0 fs-14 text-black">Pizza (40%)</p>
									<p class="mb-0 fs-14">25</p>
								</div>
							...
							<div class="mb-3">
								<div class="d-flex justify-content-between mb-3">
									<p class="mb-0 fs-14 text-black">Juice (35%)</p>
									<p class="mb-0 fs-14">60</p>
								</div>
								<div class="progress" style="height:8px;">
							...
							<div class="mb-3">
								<div class="d-flex justify-content-between mb-3">
									<p class="mb-0 fs-14 text-black">Dessert (25%)</p>
									<p class="mb-0 fs-14">7</p>
								</div>
								<div class="progress" style="height:8px;">
									<div class="progress-bar progress-animated bg-info" style="width: 25%;"></div>
								</div>
							</div>
						</div>
					</div>
