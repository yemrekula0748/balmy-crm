...
<style>
.fault-report-hero {
    background: linear-gradient(135deg, #1e293b 0%, #7c2d12 58%, #b45309 100%);
    color: #fff;
    border-radius: 18px;
    padding: 26px 30px;
    margin-bottom: 22px;
...
.fault-report-hero small { color: rgba(255,255,255,.68); font-weight: 700; letter-spacing: .08em; text-transform: uppercase; }
.fault-report-hero h3 { margin: 7px 0 8px; font-weight: 850; letter-spacing: -.02em; }
.fault-report-hero p { margin: 0; color: rgba(255,255,255,.76); max-width: 780px; line-height: 1.65; }
