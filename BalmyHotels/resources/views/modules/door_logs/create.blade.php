            ...
            <div class="mc-info-panel">
                ...
                <div class="mc-info-item">
                    ...
                    <div class="mc-info-item-text">
                        <strong>Manuel Kayıt</strong>
                        <span>QR okutma yerine elle giriş/çıkış kaydı oluşturabilirsiniz.</span>
                    </div>
                </div>
                ...
                <div class="mc-info-item">
                    ...
                    <div class="mc-info-item-text">
                        ...
                        <span>Listede departman müdürleri, şube müdürleri ve yöneticiler görünür.</span>
                    </div>
                </div>
                ...
                <div class="mc-info-item">
                    ...
                    <div class="mc-info-item-text">
                        ...
                        <span>Geriye dönük kayıt girebilirsiniz; varsayılan şimdiki zamandır.</span>
                    </div>
                </div>
                ...
                <div class="mc-info-item">
                    ...
                    <div class="mc-info-item-text">
                        <strong>Önlem</strong>
                        <span>İçerideyken tekrar giriş veya dışarıdayken çıkış kaydı oluşturulamaz.</span>
                    </div>
                </div>
...
@endpush
    ...
    background: #fff;
    border-radius: 20px;
    box-shadow: 0 4px 6px -1px rgba(0,0,0,.06), 0 20px 60px -10px rgba(79,70,229,.12);
    overflow: hidden;
}
.mc-header {
    background: linear-gradient(135deg, #1e1b4b 0%, #4338ca 60%, #6366f1 100%);
    ...
    <div class="mc-wrap">
        <div class="mc-card">
            ...
            <div class="mc-header">
                ...
                <div class="mc-header-text">
                    <h5>Manuel Kayıt</h5>
                    <p>Personel giriş veya çıkış kaydı oluştur</p>
                </div>
            </div>
...
(function () {
    ...
    function activateCard(active, inactive, activeClass, inactiveClass, activeColor, activeIconBg, inactiveIconBg, inactiveIconColor, activeIcon, inactiveIcon) {
        active.classList.add(activeClass);
        active.classList.remove(inactiveClass);
        active.querySelector('.mc-type-icon').style.background = activeIconBg;
        activeIcon.setAttribute('stroke', activeColor);

        inactive.classList.remove(activeClass);
        inactive.classList.add('');
        inactive.querySelector('.mc-type-icon').style.background = inactiveIconBg;
        inactiveIcon.setAttribute('stroke', inactiveIconColor);
    }
    ...
    if (cardGiris && cardCikis) {
        cardGiris.addEventListener('click', function () {
            cardGiris.classList.add('is-giris-active');
            cardGiris.classList.remove('is-cikis-active');
            cardCikis.classList.remove('is-cikis-active');
            cardCikis.classList.remove('is-giris-active');
            cardGiris.querySelector('.mc-type-icon').style.background = '#dcfce7';
            cardCikis.querySelector('.mc-type-icon').style.background = '#f1f5f9';
            iconGiris.setAttribute('stroke', '#16a34a');
        ...
        cardCikis.addEventListener('click', function () {
            cardCikis.classList.add('is-cikis-active');
            cardCikis.classList.remove('is-giris-active');
            cardGiris.classList.remove('is-giris-active');
            cardGiris.classList.remove('is-cikis-active');
            cardCikis.querySelector('.mc-type-icon').style.background = '#fee2e2';
            cardGiris.querySelector('.mc-type-icon').style.background = '#f1f5f9';
            iconCikis.setAttribute('stroke', '#dc2626');
